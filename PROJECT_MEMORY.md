...
| WP8/MVP13 当前口径 | 2026-04-03 `WP8/MVP13` 已完成 `T00/T10/T20/T30/T40/T50/T60/T70/T80`，formal owner 已固定在 `OpenEmotion/openemotion/self_model/*`，`runtime_v2 -> proto_self_runtime -> proto_self_adapter -> proto_self_v2` 已能读 `runtime_summary.self_model_context` 并把 gated `self_model_writeback` 挂回宿主上下文；`OpenEmotion/tools/run_mvp13_local_evidence.py` 仍是本地 `V3/E3` 证据包，但现在已通过 `OpenEmotion/tools/run_mvp13_controlled_observation.py` 拿到第一条 controlled `V4/E4` formal owner writeback 样本：`gate_verdict = allow_writeback`、`changed_fields = [confidence_by_domain, known_unknowns]`、`revision_id = rev_000002`、`replay_valid = true`。当前阶段已进入观察期，剩余 blocker 是 `E5` 稳定口径，不是主链接线缺失 |
