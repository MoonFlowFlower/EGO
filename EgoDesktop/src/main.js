...
async function captureSmoke(window, outDir, rendererPayload, signalFrame) {
  ...
  const report = {
    ...
    tts_source_visible_text: rendererPayload.ttsSmoke ? String(rendererPayload.ttsSmoke.source_visible_text || "") : "",
    tts_text: rendererPayload.ttsSmoke ? String(rendererPayload.ttsSmoke.text || "") : "",
    ...
    tts_removed_non_speech_tokens: Boolean(rendererPayload.ttsSmoke && rendererPayload.ttsSmoke.removed_non_speech_tokens),
