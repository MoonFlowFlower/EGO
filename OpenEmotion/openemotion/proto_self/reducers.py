...
from openemotion.proto_self.trial1_shadow import (
    trial1_variant_uses_correction_public_path,
    trial1_variant_uses_counterfactual_public_path,
    trial1_variant_uses_corrective_trace,
    trial1_variant_uses_viability_public_path,
)
...
def update_memory(
    ...
    if perceived.get("trial1_shadow_active"):
        ...
        if trial1_variant_uses_corrective_trace(variant_id) and (
...
def derive_policy_hint(
    ...
    correction_public_path = (
        not perceived.get("trial1_shadow_active") or trial1_variant_uses_correction_public_path(variant_id)
    )
    counterfactual_public_path = (
        not perceived.get("trial1_shadow_active") or trial1_variant_uses_counterfactual_public_path(variant_id)
    )
    viability_public_path = (
        not perceived.get("trial1_shadow_active") or trial1_variant_uses_viability_public_path(variant_id)
    )
    policy = {
