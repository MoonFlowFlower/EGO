...
- sample_ids: `sample_20260327_193954_7ab41a5b`, `sample_20260327_194005_25c165d3`
...
## restore
- status: `direct_real`
- sample_ids: `sample_20260327_230603_c55d9294`, `sample_20260327_230605_5dec2d7a`, `sample_20260327_230613_829d0fe7`
- external_evidence_refs: 无
- what_it_proves: 显式 restore 后，首条真实用户消息已形成完整 E4 bundle，随后 continuity probe 再次命中既有默认规则。
- what_it_does_not_prove: 不证明 E5 稳定成立，也不等于更长窗口下 continuity 已稳定。
- blocker: restore 首次正式补证已完成；当前更高优先级 blocker 已切到 post-restart 样本完整度与 evidence gap。
