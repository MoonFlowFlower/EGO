...
- generated_at: `2026-04-09T23:13:30.521852+00:00`
- source_artifact: `artifacts/self_awareness_research/TRIAL2_PUBLIC_DRIVER_RERUN_CURRENT.json`
...
- `trial2_ablation_correction_public_path_sever`: admission=True, decision_adjacent=True, replay_efficacy=False, weighted=0.0500, decision=0.0000, response=0.0000, policy=0.2500, trace=0.0000
- `trial2_ablation_viability_public_path_sever`: admission=True, decision_adjacent=True, replay_efficacy=False, weighted=0.0500, decision=0.0000, response=0.0000, policy=0.2500, trace=0.0000

## Ablation Separation

- `trial1_ablation_counterfactual_public_path_sever`: mean_weighted_gap=0.0500, positive_gap_cases=8
- `trial2_ablation_correction_public_path_sever`: mean_weighted_gap=0.0000, positive_gap_cases=0
- `trial2_ablation_viability_public_path_sever`: mean_weighted_gap=0.0000, positive_gap_cases=0
