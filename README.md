...
- 当前 archive/governance closeout 使用 tag `legacy-pre-operator-mainline-before-purge` 作为旧三项目回滚指针
...
- 旧正式/compat/reference/deprecated 路径登记只保留在 git 历史和 [legacy/ego-pre-handmade-mainline/ARCHIVED_POINTER.md](legacy/ego-pre-handmade-mainline/ARCHIVED_POINTER.md) 指向的 archive pointer 中；复用必须先有新的 Stage Card 和 evidence gate
...
- [legacy/ego-pre-handmade-mainline/ARCHIVED_POINTER.md](legacy/ego-pre-handmade-mainline/ARCHIVED_POINTER.md)
- [docs/archive/LEGACY_ALGORITHM_INVENTORY.md](docs/archive/LEGACY_ALGORITHM_INVENTORY.md)
