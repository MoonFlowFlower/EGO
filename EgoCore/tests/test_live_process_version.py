...
def test_unexpected_dirty_paths_ignores_runtime_generated_files():
    status = "\n".join(
        [
            ...
            " M OpenEmotion/artifacts/mvp19/controlled_batch_x/formal_selfhood_integration/openemotion/selfhood_integration_revisions.jsonl",
            " M OpenEmotion/artifacts/mvp21/controlled_batch_y/formal_initiative_realization/openemotion/initiative_realization_state.json",
