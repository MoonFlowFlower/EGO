...
> 状态：WP13 legacy demotion complete + T10 completed + T20 completed + T30 completed + T40 completed + T50 pending
...
- 当前最小闭环动作：只开 `T50_CAUSAL_VALIDATION`，不提前进入 observation
