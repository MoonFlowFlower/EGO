...
- 当前下一阶段已冻结为 `WP13/MVP18` 的 authority/task package，范围收窄为 `Embodied Loop / Environment Coupling (host-governed, proposal-only)`；`T10` formal owner package、`T20` proto-self contract integration、`T30` EgoCore runtime bridge 与 `T40` legacy demotion / compat map 已完成，当前证据维持在 `V3/E3`，但仍未进入 causal proof 或 observation。
...
- 当前 blocker：`WP13` 仍未开始 `T50` causal validation；当前不能宣称已进入 observation、已启用或有 `E4/E5`
