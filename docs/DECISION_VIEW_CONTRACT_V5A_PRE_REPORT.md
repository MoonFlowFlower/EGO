...
Claim ceiling: lab-only decision-view contract proof.
...
```json
{
  ...
  "evidence_log_path": "temp/ego_desktop_lab/decision_view_v5a_pre/report.jsonl",
  "gate_decision": {
...
Evidence log path: `temp/ego_desktop_lab/decision_view_v5a_pre/report.jsonl`
